...
System.register("chunks:///_virtual/main", ['./GameContent.ts', './RemoteEntryLoader.ts'], function () {
  return {
    setters: [null, null],
    execute: function () {}
  };
...
System.register("chunks:///_virtual/RemoteEntryLoader.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './env'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Asset, Label, ProgressBar, Button, _decorator, Component, native, sys, game, NATIVE;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let RemoteEntryLoader = exports('RemoteEntryLoader', (_dec = ccclass('RemoteEntryLoader'), _dec2 = property(Asset), _dec3 = property(Label), _dec4 = property(ProgressBar), _dec5 = property(Button), _dec6 = property(Button), _dec(_class = (_class2 = class RemoteEntryLoader extends Component {
        ...
        onLoad() {
          ...
          this.storagePath = (native.fileUtils && native.fileUtils.getWritablePath ? native.fileUtils.getWritablePath() : '/') + 'hot-update/';
